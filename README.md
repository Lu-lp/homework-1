...
<html>
    ...
    <body>
        <h1 >Grandma's Lemon Meringue Pie</h1>
            <img src="https://courses.cs.washington.edu/courses/cse190m/09sp/homework/1/pie.jpg" alt="the picture of pie">
            <p class="text-paragraph">One 9-inch pie<br />
            30 Min - Prep time<br />
            10 Min - Cook time<br />
            40 Min - Total<br />
            8 Servings</p>
        ...
        <hr />
        <h2>LINKS</h2>
         <a href="https://www.google.com.hk/search?q=lemon+meringue+pie+recipe." class="text-link">
            Search for other lemon meringue pie recipes</a><br />
         <a href="index.html" class="text-link" >Home</a> <br />
         <br />
         <a href="http://validator.w3.org/check/referer"><img src="http://www.w3.org/Icons/valid-xhtml11"></a> 
         <a href="http://jigsaw.w3.org/css-validator/check/referer"> <img src="http://jigsaw.w3.org/css-validator/images/vcss"> </a>
